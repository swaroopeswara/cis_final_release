import { Component, OnInit, ViewEncapsulation, ElementRef, HostListener, EventEmitter, Output, AfterViewInit } from '@angular/core';
...
export class MenuComponent implements OnInit {
    ...
    constructor(private _elementRef: ElementRef,
        ...
        private apiService: RestcallService,
        ...
        this.apiService.getMenuOfUser(localStorage.getItem('cis_selected_rolecode')).subscribe(data => {
            ...
            this.menuItems = memulistobj.Menu.MainItem;
        }, error => {
            console.log(error);
        });

        this.globals.menuItems.subscribe(data => {
            this.menuItems = data;
          });    

        // this.menuItems = _menuService.getMenuItems();
        // console.log(_menuService.getMenuItems());
    ...
    public collapseMenu($event, item, url): boolean {
        if (url != '#') {
